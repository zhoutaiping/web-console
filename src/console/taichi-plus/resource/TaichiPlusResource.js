...
export default {
  ...
  addNewRuleFunBatch: params =>
    TaichiPlusResource.post('V4/Tjkd.plus.forward.rule.batch.add', {
      ...params
    }),
  editRuleFunBatch: params =>
    TaichiPlusResource.post('V4/Tjkd.plus.forward.rule.batch.info', {
      ...params
    }),
  saveEditRuleBatch: params =>
    TaichiPlusResource.post('V4/Tjkd.plus.forward.rule.batch.save', {
      ...params
    }),
  ...
  addPlusMessageList: params =>
    TaichiPlusResource.post('V4/Tjkd.plus.forward.rule.packet.message.add', {
      ...params
    }),
  ...
  changeTableMessageList: params =>
    TaichiPlusResource.put('V4/Tjkd.plus.forward.rule.packet.message.save', {
      ...params
    }),
  ...
  delTableMessageList: params =>
    TaichiPlusResource.delete('V4/Tjkd.plus.forward.rule.packet.message.del', {
      data: {
        ...params
      }
    }),
  ...
  getTableMessageList: params =>
    TaichiPlusResource.get('V4/Tjkd.plus.forward.rule.packet.message.list', {
      params: {
        ...params
      }
    }),
