<template>
  <yd-dialog :visible.sync="invoiceInfoVisible" :close-on-click-modal="true" title="发票详情" size="small" @open="getInvoiceDetails" @close="resetStatus">
    <div v-loading="infoLoading" class="wrapper">
