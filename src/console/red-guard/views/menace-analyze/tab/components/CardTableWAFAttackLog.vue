<template>
  <DmCard title="定向攻击事件">
      ...
      <DmTable :loading="loading">
        <el-table :data="list">
          ...
          >
            <template slot-scope="scope">
              <router-link :to="{
                name:'cloud-speed.router.menaceAnalyze__WAFAttack_WAFAttackDetail',
                query:{
                  ...scope.row
                }
              }">
    ...
    <DialogWAFAttackDetail ref="DialogWAFAttackDetail" />
  </DmCard>
</template>

<script>
import consoleData from '@/mixins/consoleData'
import DialogWAFAttackDetail from './components/DialogWAFAttackDetail'
import ColumnThreatenLevel from './components/ColumnThreatenLevel'
import Label from '@/console/cloud-speed/constant/label'

export default {
  components: { DialogWAFAttackDetail, ColumnThreatenLevel },
  ...
  methods: {
    handleDetail(row) {
      this.$refs.DialogWAFAttackDetail.handleOpen(row)
    },
